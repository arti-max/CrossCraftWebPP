...
void SettingsScreen::init() {
    for (int i = 0; i < 5; ++i) {
        this->buttons.push_back(new Button(i, this->width / 2 - 100, this->height / 6 + i * 24, 200, 20, this->settings->getSettingStateStr(i)));
    }

    this->buttons.push_back(new Button(10, this->width / 2 - 100, this->height / 6 + 120 + 12, 200, 20, "Controls..."));
    this->buttons.push_back(new Button(20, this->width / 2 - 100, this->height / 6 + 168, 200, 20, "Done"));
}
