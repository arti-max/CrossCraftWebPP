...
void Tile::renderFace(Tessellator& t, int x, int y, int z, int face) {
    ...
    const int atlasPixels = 256;

    const int col = tex % atlasSize;
    const int row = tex / atlasSize;
